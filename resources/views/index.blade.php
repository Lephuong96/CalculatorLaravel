...
<form action="" method="post" class="col-4 align-content-center">
    @csrf
    <div class="form-group">
        <label>Number 1</label>
        <input type="integer" class="form-control" name="number1" required value="{{$number1}}">
    </div>
    <div class="form-group">
        <label>Number 2</label>
        <input type="integer" class="form-control" name="number2" required value="{{$number2}}">
    </div>
